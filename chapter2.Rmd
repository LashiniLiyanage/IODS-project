...
```{r}
# Graphical Representation of Exam Points with other Variables

## Gender and Exam Points

p1 <- ggplot(learning2014, aes(x = gender, y = points, fill = gender)) +
...
a1 <- ggplot(learning2014, aes(x = age, y = points)) +
...
b1 <- ggplot(learning2014, aes(x = attitude, y = points)) +
...
c1 <- ggplot(learning2014, aes(x = stra,  y = points)) +
...
d1 <- ggplot(learning2014, aes(x = deep, y = points)) +
...
e1 <- ggplot(learning2014, aes(x = surf, y = points)) +
...
Model3 <- lm(points ~ attitude , data = learning2014)
summary(Model3)
```
